...
//        [_cancelBtn setImage:HGImage(@"cuo") forState:(UIControlStateNormal)];
        [_cancelBtn setTitleColor:MainColor
...
//        [_sureBtn setImage:HGImage(@"dui") forState:(UIControlStateNormal)];
